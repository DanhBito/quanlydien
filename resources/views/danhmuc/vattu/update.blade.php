        ...
        <div class="modal-body " >
          <form action="#" id="form-update">
            ...
            <div class="form-group row">
                ...
                <input type="number" class="col-md-6 form-control" id="u-sup_price" min="1" maxlength="12" required/>
            </div>

            <div class="form-group row select-quality">
              <label class="col-md-4 text-md-right font-weight-bold" >Chất Lượng</label>
              <select class="col-md-6 form-control" name="qua_id" id="u-qua_id" class="form-control" name="postion" required>
                  <option value="">-- Chọn --</option>
                  @foreach ($quas as $qua)
            ...
            <div class="form-group row select-producer">
              ...
              <select class="col-md-6 form-control"  name="pro_id" id="u-pro_id" class="form-control" name="postion" required>
                  <option value="">-- Chọn --</option>
                  @foreach ($pros as $pro)
